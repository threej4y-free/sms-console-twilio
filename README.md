...
A interface divide automaticamente listas grandes em lotes. A Twilio processa até 100 destinatários por requisição. Para dar margem ao tempo de resposta do provedor, a SMSFire usa lotes de 50 destinatários e timeout de 60 segundos. Entre os lotes da SMSFire, a interface aguarda 10 segundos, mantendo o ritmo em no máximo 6 requisições por minuto.
...
- Cada lista pode armazenar até 100.000 destinatários no navegador. A Twilio é processada em solicitações de até 100 destinatários. A SMSFire usa o endpoint em massa com 50 destinatários por solicitação, timeout de 60 segundos e intervalo de 10 segundos entre os lotes.
